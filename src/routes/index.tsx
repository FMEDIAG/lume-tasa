        ...
        <div className="relative mx-auto max-w-xl px-5 pb-24 pt-8">
          ...
          {!result && (
            <section className="mt-8">
              ...
              />
              <a
                href="https://paypal.me/FMEDIAG"
                target="_blank"
                rel="noopener noreferrer"
                className="glass-crystal mx-auto mt-4 flex w-fit items-center gap-1.5 rounded-full px-4 py-2 text-xs font-semibold text-primary transition hover:bg-primary/15"
              >
