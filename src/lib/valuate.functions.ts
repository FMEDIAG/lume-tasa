...
const ResultSchema = z.object({
  ...
  priceEurMin: z.number().finite().nonnegative().max(10_000_000),
  priceEurMax: z.number().finite().nonnegative().max(10_000_000),
  priceUsdMin: z.number().finite().nonnegative().max(10_000_000),
  priceUsdMax: z.number().finite().nonnegative().max(10_000_000),
