...
export function CameraCapture({ onCapture, onClose, t }: CameraCaptureProps) {
  ...
  async function applyZoom(level: ZoomLevel) {
    ...
    if (track && caps.zoom) {
      ...
      try {
        ...
        /* fallback a zoom digital si el hardware falla */
      }
    }
  ...
  async function toggleMacro() {
    ...
    if (track && supportsFocus) {
      try {
        ...
        /* mantiene asistencia digital */
      }
    }
    
    // Asistencia de zoom al activar o desactivar Macro
  ...
  async function toggleTorch() {
    ...
    try {
      ...
      /* ignora errores si el dispositivo no permite linterna */
    }
  }
  ...
  function capturePhoto() {
    ...
    const z = digitalZoom;
    // Recorte central según el zoom digital aplicado
    ...
    // En modo Macro conservamos mayor resolución (1600px) para no perder detalle fino
    ...
    // Entregamos el objeto enriquecido con la foto, el estado de Macro y el Zoom
    onCapture({
      dataUrl,
      isMacro: macro,
      zoom,
